...
const Speaker = () => {
    return (
        <section className="w-full py-15 bg-[#F3F0FB]">
            <div className="max-w-6xl m-auto space-y-8">
                <div className="text-center">
                    <h3 className="text-[32px] text-[#FE2676] font-['Caveat',sans-serif] font-bold">Speaker</h3>
                    <h1 className="text-[#283746] text-[46px] font-bold">Popular Speakers</h1>
                </div>
