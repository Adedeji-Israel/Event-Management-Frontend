...
const CheckoutPageOne = () => {
    ...
    useEffect(() => {
        const fetchEvent = async () => {
            ...
            const initial = eventData.ticketTypes.map((t: TicketType) => ({
                ticketTypeId: t._id,
                quantity: 0,
            }));
            ...
            <div className="bg-gray-100 min-h-screen space-y-6 py-6 px-6">
                ...
                <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Event About (Optional Extended Section) */}
                        <div className="bg-white p-6 rounded-2xl shadow-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm">
                            ...
                            <button
                                ...
                                className={`w-full mt-6 py-3 rounded-xl text-white font-semibold transition ${totalQuantity === 0
